...
class _ReminderScreenState extends State<ReminderScreen> {
  ...
  Future<void> _deleteReminder(int id) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(AppText.get('reminderDeleted'))));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppText.get('reminder')),
        actions: [
          IconButton(
                        ...
                        child: Row(
                          children: [
                            ...
                            Switch(
                              ...
                              onChanged: (val) =>
                                  _toggleReminderStatus(reminder, val),
                            ),
                          ],
                        ),
                      ),
