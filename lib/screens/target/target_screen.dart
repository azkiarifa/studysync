...
class _TargetScreenState extends State<TargetScreen> {
  ...
  Future<void> _deleteTarget(int id) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Target kuliah berhasil dihapus')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Course Target'),
        actions: [
          IconButton(
          ...
          : _targets.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final progress = (target.currentScore / target.targetScore).clamp(0.0, 1.0);
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        'Nilai Saat Ini: ${target.currentScore.toStringAsFixed(1)}',
                                        style: TextStyle(
                                          fontSize: 13,
                                          color: isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary,
                                        ),
                                      ...
                                      Text(
                                        'Sasaran: ${target.targetScore.toStringAsFixed(1)}',
                                        style: TextStyle(
                                          fontSize: 13,
                                          color: isDark ? AppColors.darkTextSecondary : AppColors.lightTextSecondary,
                                          fontWeight: FontWeight.bold,
